/*10. Napisati program koji Äita datoteku drzave.txt u kojoj su zapisani nazivi pojedinih drÅ¾ava. Uz
...
broj_stanovnika.
a) Potrebno je formirati sortiranu vezanu listu drÅ¾ava po nazivu. Svaki Ävor vezane liste
sadrÅ¾i stablo gradova sortirano po broju stanovnika, zatim po nazivu grada.
b) Potrebno je formirati stablo država sortirano po nazivu. Svaki Ävor stabla sadrÅ¾i vezanu
listu gradova sortiranu po broju stanovnika, zatim po nazivu grada.
Nakon formiranja podataka potrebno je ispisati drÅ¾ave i gradove te omoguÄ‡iti korisniku putem
tastature pretragu gradova odreÄ‘ene drÅ¾ave koji imaju broj stanovnika veÄ‡i od unosa na
tastaturi.*/
